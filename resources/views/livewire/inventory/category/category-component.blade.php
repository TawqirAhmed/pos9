            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <button type="button" class="btn btn-outline-success waves-effect width-md float-right" data-toggle="modal" data-target="#modalAdd" data-overlaySpeed="200" data-animation="fadein">New Category</button>
                        </div> 
                    </div>             
                </div>
                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="search" wire:model="search" class="form-control input-sm" placeholder="Search By Name, Modified By">
                                    </div>
                                </div>
                                <br>
