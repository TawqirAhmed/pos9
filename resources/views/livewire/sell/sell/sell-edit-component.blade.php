                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Sell</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Edit Sell</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                        ...
                        <div class="col-12">
                            ...
                            <form role="form" wire:submit.prevent="Store()" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        {{-- <button style="margin-top: 16px" type="button" class="btn btn-outline-success waves-effect width-md float-right" data-toggle="modal" data-target="#modalCustomerMakeSales" data-overlaySpeed="200" data-animation="fadein">New Customer</button> --}}
                                    </div>
