...
class DueSellExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents
{
    /**
    ...
    */
    ...
    {
        $sells = Sell::with('user', 'customer', 'payment_method')->where('due','>',0)->where('created_at','>=',$this->from)->where('created_at','<=', $this->to)->get();
